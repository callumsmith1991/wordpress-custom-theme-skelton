...
module.exports = {
	...
	// Project options.
	projectURL: 'http://localhost:8888/fore-website-1/', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	jsCustomDestination: './js/min-scripts', // Path to place the compiled JS custom scripts file.
